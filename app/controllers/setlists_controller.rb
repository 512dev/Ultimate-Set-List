class SetlistsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @setlist.save
        format.html { redirect_to setlist_path, notice: 'Set was successfully created.' }
  ...
  def show
    artist_search = RSpotify::Artist.search(params[:artist])
    artist = artist_search.first
    @albums = artist.albums(limit: 50, country: current_user.market)
  end
  ...
  def setlist_params
    params.require(:setlist).permit(:name, :artist)
  end
end
